...
func easyjsonF248ab8DecodeGithubComGldmtrBotGolang(in *jlexer.Lexer, out *ButtonResponse) {
...
func easyjsonF248ab8EncodeGithubComGldmtrBotGolang(out *jwriter.Writer, in ButtonResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ButtonResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF248ab8EncodeGithubComGldmtrBotGolang(&w, v)
...
func (v *ButtonResponse) UnmarshalJSON(data []byte) error {
	...
	easyjsonF248ab8DecodeGithubComGldmtrBotGolang(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ButtonResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF248ab8DecodeGithubComGldmtrBotGolang(l, v)
}
func easyjsonF248ab8DecodeGithubComGldmtrBotGolang1(in *jlexer.Lexer, out *Button) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF248ab8EncodeGithubComGldmtrBotGolang1(out *jwriter.Writer, in Button) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Button) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF248ab8EncodeGithubComGldmtrBotGolang1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Button) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF248ab8DecodeGithubComGldmtrBotGolang1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Button) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF248ab8DecodeGithubComGldmtrBotGolang1(l, v)
}
